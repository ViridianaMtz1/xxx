<%-- 
    Document   : Registro
    Created on : 16/06/2021, 08:26:38 PM
    Author     : HOME
--%>
...
<html>
    <head>
        ...
        <title>JSP Page Formulario Alumno</title>
    ...
    <body>
         <div class="container well">
            <div class="alert-info">
                <% // Inicia Scrioplet   declaracion de variables 
                    int matriculaAlu=Integer.parseInt(request.getParameter("matri"));
                    String nombreAlu=request.getParameter("nom");
                     String apePatAlu=request.getParameter("apepat");
                     String apeMatAlu=request.getParameter("apemat");                    
                %>
                
                <!--Para imprimir resultado Final de datos-->
                
                <hr>
                <center>
                    <h2>Confirmacion de datos en formulario</h2>
                    <h3>Matricula Alumno: <%= matriculaAlu %> </h3>
                    <h3>Nombre Alumno: <%= nombreAlu %>  </h3>
                    <h3>Apellido Paterno Alumno: <%= apePatAlu %> </h3>
                    <h3>Apellido Materno Alumno: <%= apeMatAlu %> </h3>
                    <hr>
                    <h4>Fecha y hora de sistema <%= new java.util.Date() %> </h4>
                </center>
                <hr>
            </div>
        </div>
